...
---
## Documentaion
### [titanSideCars](https://github.com/Broadcom/cloud-tools-titans/blob/develop/docs/config-reference.md) - In progress

  | Feature | Description | Config Reference| Examples |
| --- | --- | --- | --- |
| Token Validation  | Enable/configure JWT token validation |  [Ingress level token validation policy](https://github.com/Broadcom/cloud-tools-titans/blob/develop/docs/config-reference.md#tokencheck) <br /> [Per route token validation policy](https://github.com/Broadcom/cloud-tools-titans/blob/develop/docs/config-reference.md#tokencheck-1) | [Examples](https://github.com/Broadcom/cloud-tools-titans/blob/develop/docs/examples-token-validation.md)  |
| API Metrics | Enable/configure API operation metrics | [Per route metrics config](https://github.com/Broadcom/cloud-tools-titans/blob/develop/docs/config-reference.md#perroutemetrics)  |  [Example](https://github.com/Broadcom/cloud-tools-titans/blob/develop/docs/examples-service-api-metrics.md) |
| Global Ratelimit | Enable/configure global API ratelimiting| [Ratelimit sidecar config](https://github.com/Broadcom/cloud-tools-titans/blob/develop/docs/config-reference.md#ratelimit-1) <br /> [OPA sidecar config](https://github.com/Broadcom/cloud-tools-titans/blob/develop/docs/config-reference.md#opa-1) <br /> [Per route ratelimit config](https://github.com/Broadcom/cloud-tools-titans/blob/develop/docs/config-reference.md#perrouteratelimit)| [Examples](https://github.com/Broadcom/cloud-tools-titans/blob/develop/docs/examples-global-ratelimiting.md) |
| Access Policy  | Enable/configure API auhorization enforcement   |  [OPA sidecar config](https://github.com/Broadcom/cloud-tools-titans/blob/develop/docs/config-reference.md#opa-1) <br /> [Default access policy config](https://github.com/Broadcom/cloud-tools-titans/blob/develop/docs/config-reference.md#ingressaccesspolicy) <br /> [Per route access policy config](https://github.com/Broadcom/cloud-tools-titans/blob/develop/docs/config-reference.md#perrouteaccesspolicy) | [Examples](https://github.com/Broadcom/cloud-tools-titans/blob/develop/docs/examples-access-policy.md)  |
|   |   |   |   |
